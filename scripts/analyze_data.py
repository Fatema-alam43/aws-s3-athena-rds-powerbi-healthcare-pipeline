...
queries = {
    ...
    "Query 6 - Patient-Level Risk Factors (raw)": """
        SELECT
          age,
          hypertension,
          heart_disease,
    ...
    "Query 7 - Stroke Rate by Single-Year Age": """
        SELECT
    ...
    "Query 8 - Stroke Rate by BMI Category": """
        SELECT
          CASE
    ...
    "Query 9 - Stroke Rate by Glucose Category": """
        SELECT
          CASE
    ...
    "Query 10 - Stroke Rate by Gender and Age Band": """
        SELECT
          gender,
          CASE
            WHEN age < 30 THEN 'Under 30'
